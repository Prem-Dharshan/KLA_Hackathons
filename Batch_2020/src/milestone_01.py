...
def main():
    ...
    with open('../Milestone_Input/Milestone 1/Format_Source.txt', 'r') as input_file:
    ...
    with open('../Milestone_Input/Milestone 1/POI.txt', 'r') as input_file:
    ...
    with open('../Milestone_Output/Milestone 1/output.txt', 'w') as output_file:

        for polygon in polygons:
            poly_edges, poly_angles = get_edges_and_angles(polygon)

            print(poly_edges.isS, poly_angles)
