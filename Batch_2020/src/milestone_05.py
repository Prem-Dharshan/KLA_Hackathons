...
def main():
    ...
    with open('../Milestone_Input/Milestone 5/Source.txt', 'r') as input_file:
    ...
    with open('../Milestone_Input/Milestone 5/POI.txt', 'r') as input_file:
    ...
    with open('../Milestone_Output/Milestone 5/output.txt', 'w') as output_file:
