...
def main():
    ...
    with open('../Milestone_Input/Milestone 6/Source.txt', 'r') as input_file:
    ...
    with open('../Milestone_Input/Milestone 6/POI.txt', 'r') as input_file:
    ...
    with open('../Milestone_Output/Milestone 6/output.txt', 'w') as output_file:
